...
You can also build a docker package using:
    ...
    docker run -it -v /beldex/chain:/root/.beldex -v /beldex/wallet:/wallet -p 22022:22022 beldex 
    
    # or in background
    docker run -it -d -v /beldex/chain:/root/.beldex -v /beldex/wallet:/wallet -p 22022:22022 beldex 
    ```
